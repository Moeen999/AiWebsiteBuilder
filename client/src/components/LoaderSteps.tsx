...
const LoaderSteps = () => {
  ...
  return (
    <div className="w-full h-full flex flex-col justify-center items-center bg-gray-900 gap-3 relative overflow-hidden text-white">
      ...
      {/* step label - fade using trasition only */}
      <p className="mt-8 text-lg font-light text-white/90 tracking-wide transition-all duration-700 ease-in-out opacity-100">
        {steps[current].label}
      </p>
      <p className="text-xs text-gray-400 mt-2 transition-opacity duration-75 opacity-1000">
        This may take around 4-5 minutes...
      </p>
    </div>
  );
};
